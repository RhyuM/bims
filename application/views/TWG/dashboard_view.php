<?php 
    $this->load->view('TWG/layouts/head');
    $this->load->view('TWG/layouts/header');
    // $this->load->view('TWG/layouts/sidebar');
?>
...
<div class="page-content-wrapper">
    ...
    <?php
        $this->load->view('TWG/layouts/quick_sidebar');
        $this->load->view('TWG/layouts/footer');
    ?>