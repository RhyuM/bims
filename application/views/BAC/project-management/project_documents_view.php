								...
								<div class="portlet-body">
									<div class="table-toolbar">
										...
										<div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
											...
											<form id="docs_form" method="post" action="<?php echo base_url(); ?>ProjectManagementController/download">
												<button type="submit" class="btn green" id="download_docs">Download all</button>
												<h2>Technical documents</h4>
												<div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
														<thead>
															<tr role="row">
																<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Email">Description</th>
																<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Status" style="width:20%;">Document File</th>
															</tr>
														</thead>
...
<script  type="text/javascript">
	...
	// 	jQuery.ajax({
	// 		type  : 'get',
	// 		url   : '<?php echo base_url('BidOpeningController/technical_evaluation_result_show')?>/<?php echo $session_bids_id ?>',
	// 		async : true,
	...
	$( window ).load(function() {
		jQuery.ajax({
			type  : 'get',
			url   : '<?php echo base_url('ProjectManagementController/financial_docs_show')?>',
			async : true,
			success : function(data){
		...
		jQuery.ajax({
			type  : 'get',
			url   : '<?php echo base_url('ProjectManagementController/technical_docs_show')?>',
			async : true,
			success : function(data){
		...
		jQuery.ajax({
			type  : 'get',
			url   : '<?php echo base_url('ProjectManagementController/other_docs_show')?>',
			async : true,
			success : function(data){
	...
	// $('#docs_form').submit(function(event){
    //     event.preventDefault();
	// 	jQuery.ajax({
	// 		type  : 'get',
	// 		url   : '<?php echo base_url('ProjectManagementController/download') ?>',
	// 		// data : $('#docs_form').serialize(),
	// 		async : true,
	// 		success : function(data){
	...
	$('.table_data1,.table_data2, .table_data3').on('click','.img_button',function(){
		$('.spinner-box').fadeIn();
